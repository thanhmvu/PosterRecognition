...
{
    char *poster_labels[] = {"zero","one","two","three","four","five","six","seven","eight","nine"};
    int classes = 10;
    ...
    char *backup_directory = "../../database/imagenet/weights";
    printf("%s\n", base);
...
void validate_imagenet(char *filename, char *weightfile)
{
    ...
    list *plist = get_paths("../../database/testPosters/5C_100P_s0_test/test.txt");
...
//         pthread_join(load_thread, 0); // break here
//         val = buffer;
...
//         free_data(val);
//     }
    data val = load_data(paths, m, 0, poster_labels, classes, net.w, net.h);
